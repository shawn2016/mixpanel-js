        ...
        setTimeout(function() {
            ...
            if (!window.COOKIE_FAILURE_TEST) {
                ...
                test("cookie upgrade", 12, function() {
                    ...
                    var cu1 = mixpanel.init("ajsfdjow", {
                        upgrade: 'mp_super_properties_other'
                    }, "cu1");
                    ...
                    // the current one.
                    cookie.set(old_name, mixpanel._.JSONEncode({
                        'c': 'error'
                    }));

                    var cu3 = mixpanel.init(token, {
                        upgrade: true
                    }, 'cu3');
                ...
                function getEventsFromTrackRequests(requests) {
                    return (requests || [])
                        .filter(function(item) {
                            return item.url.indexOf('http://localhost:8000/track/?data=') === 0;
                        })
