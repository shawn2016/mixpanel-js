...
!b.length?console.error("gdpr."+(a?"optIn":"optOut")+" called with an invalid token"):(d=d||{},Y(d).set(Z(b,d),a?1:0,c.fc(d.Ub)?d.Ub:w,!!d.Vb,!!d.Qd),d.o&&a&&d.o(d.Zd||"$opt_in",d.$d))}function fa(a,b){return function(){var d=D;try{var c=b.call(this,"token"),g=b.call(this,"opt_out_tracking_persistence_type"),j=b.call(this,"opt_out_tracking_cookie_prefix"),m=b.call(this,"window");c&&(d=ma(c,{nc:g,mc:j,window:m}))}catch(i){console.error("Unexpected error when checking tracking opt-out status: "+i)}if(!d)return a.apply(this,
...
u.prototype.toString=u.prototype.toString;var da,y,Ia="__mps,__mpso,__mpus,__mpa,__mpap,__mpr,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(","),ba=t.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,ka=!ba&&-1===z.indexOf("MSIE")&&-1===z.indexOf("Mozilla"),Ja={api_host:"http://localhost:8000",app_host:"https://mixpanel.com",autotrack:p,cdn:"https://cdn.mxpnl.com",cross_subdomain_cookie:p,persistence:"cookie",persistence_name:"",cookie_name:"",loaded:J(),store_google:p,save_referrer:p,
test:D,verbose:D,img:D,track_pageview:p,debug:D,track_links_timeout:300,cookie_expiration:365,upgrade:D,disable_persistence:D,disable_cookie:D,secure_cookie:D,ip:p,opt_out_tracking_by_default:D,opt_out_persistence_by_default:D,opt_out_tracking_persistence_type:"localStorage",opt_out_tracking_cookie_prefix:w,property_blacklist:[],xhr_headers:{},inapp_protocol:"//",inapp_link_new_window:D},ja=D;E.prototype.Ga=J();E.prototype.kb=J();E.prototype.eb=J();E.prototype.aa=function(a){this.ic=a;return this};
E.prototype.o=function(a,b,d,e){var g=this,j=c.wd(a);if(0===j.length)q.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,function(a){c.J(a,this.lc,function(a){var c={},j=g.Ga(d,this),f=g.ic.c("track_links_timeout");g.kb(a,this,c);t.setTimeout(g.xc(e,j,c,p),f);g.ic.o(b,j,g.xc(e,j,c))})},this),p};E.prototype.xc=function(a,b,d,c){var c=c||D,g=this;return function(){if(!d.qd)d.qd=p,a&&a(c,b)===D||g.eb(b,d,c)}};E.prototype.Ga=function(a,b){return"function"===typeof a?a(b):c.extend({},
a)};c.dc(K,E);K.prototype.Ga=function(a,b){var d=K.Xd.Ga.apply(this,arguments);if(b.href)d.url=b.href;return d};K.prototype.kb=function(a,b,d){d.jc=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;d.href=b.href;d.jc||a.preventDefault()};K.prototype.eb=function(a,b){b.jc||setTimeout(function(){t.location=b.href},0)};c.dc(U,E);U.prototype.kb=function(a,b,d){d.element=b;a.preventDefault()};U.prototype.eb=function(a,b){setTimeout(function(){b.element.submit()},0)};s.prototype.ra=function(){var a=
{};c.a(this.props,function(b,d){c.bc(Ia,d)||(a[d]=b)});return a};s.prototype.load=function(){if(!this.disabled){var a=this.w.parse(this.name);a&&(this.props=c.extend({},a))}};s.prototype.fe=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.w.parse(d),this.w.remove(d),this.w.remove(d,p),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&"mixpanel"!==a.name&&(d="mp_"+a.token+"_"+a.name,b=this.w.parse(d)))this.w.remove(d),this.w.remove(d,
p),this.G(b);this.w===c.localStorage&&(b=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,p),b&&this.G(b))};s.prototype.save=function(){this.disabled||(this.Rc(),this.w.set(this.name,c.ea(this.props),this.lb,this.hb,this.qc))};s.prototype.remove=function(){this.w.remove(this.name,D);this.w.remove(this.name,p)};s.prototype.clear=function(){this.remove();this.props={}};s.prototype.G=function(a,b,d){return c.g(a)?("undefined"===typeof b&&(b="None"),this.lb="undefined"===
typeof d?this.Wb:d,c.a(a,function(a,d){if(!this.props.hasOwnProperty(d)||this.props[d]===b)this.props[d]=a},this),this.save(),p):D};s.prototype.v=function(a,b){return c.g(a)?(this.lb="undefined"===typeof b?this.Wb:b,c.extend(this.props,a),this.save(),p):D};s.prototype.ua=function(a){a in this.props&&(delete this.props[a],this.save())};s.prototype.Rc=c.m(function(){var a=this.props.__cmpns,b=G?6E4:36E5;if(a){for(var d in a)1*new Date-a[d]>b&&delete a[d];c.T(a)&&delete this.props.__cmpns}});s.prototype.ee=
function(){if(!this.Qb)this.G(c.info.rd()),this.Qb=p};s.prototype.Cc=function(a){this.v(c.info.Pd(a))};s.prototype.xb=function(a){this.G({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.oc(a)||"$direct"},"")};s.prototype.Cd=function(){return c.La({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};s.prototype.Bc=function(a){this.Wb=this.lb=a.cookie_expiration;this.tc(a.disable_persistence);this.Rd(a.cross_subdomain_cookie);
this.Ud(a.secure_cookie)};s.prototype.tc=function(a){(this.disabled=a)?this.remove():this.save()};s.prototype.Rd=function(a){if(a!==this.hb)this.hb=a,this.remove(),this.save()};s.prototype.Ad=function(){return this.hb};s.prototype.Ud=function(a){if(a!==this.qc)this.qc=a?p:D,this.remove(),this.save()};s.prototype.C=function(a,b){var d=this.Xa(a),e=b[a],g=this.Q("$set"),j=this.Q("$set_once"),f=this.Q("$unset"),i=this.Q("$add"),h=this.Q("$union"),n=this.Q("$remove",[]),r=this.Q("$append",[]);"__mps"===
...
this.H("$append",e)):"__mpap"===d&&(r.push(e),this.H("$unset",e));q.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");q.log(b);this.save()};s.prototype.H=function(a,b){var d=this.Ba(a);c.e(d)||(c.a(b,function(b,g){"$append"===a||"$remove"===a?c.a(d,function(a){a[g]===b&&delete a[g]}):delete d[g]},this),this.save())};s.prototype.Xa=function(a){if("$set"===a)return"__mps";if("$set_once"===a)return"__mpso";if("$unset"===a)return"__mpus";if("$add"===a)return"__mpa";if("$append"===a)return"__mpap";
if("$remove"===a)return"__mpr";if("$union"===a)return"__mpu";q.error("Invalid queue:",a)};s.prototype.Ba=function(a){return this.props[this.Xa(a)]};s.prototype.Q=function(a,b){var d=this.Xa(a),b=c.e(b)?{}:b;return this.props[d]||(this.props[d]=b)};s.prototype.Sd=function(a){var b=this.props.__timers||{};b[a]=(new Date).getTime();this.props.__timers=b;this.save()};s.prototype.Kd=function(a){var b=(this.props.__timers||{})[a];c.e(b)||(delete this.props.__timers[a],this.save());return b};var h;c.extend(n.prototype,
...
"Bad HTTP status: "+j.status+" "+j.statusText,q.error(a),d&&(e?d({status:0,error:a}):d(0))};j.send(w)}catch(f){q.error(f)}else{g=o.createElement("script");g.type="text/javascript";g.async=p;g.defer=p;g.src=a;var i=o.getElementsByTagName("script")[0];i.parentNode.insertBefore(g,i)}}};f.prototype.Wa=function(a){function b(a,b){c.a(a,function(a){if(c.isArray(a[0])){var d=b;c.a(a,function(a){d=d[a[0]].apply(d,a.slice(1))})}else this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],g=[],j=[];c.a(a,function(a){a&&
(d=a[0],c.isArray(d)?j.push(a):"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?j.push(a):g.push(a))},this);b(e,this);b(g,this);b(j,this)};f.prototype.push=function(a){this.Wa([a])};f.prototype.disable=function(a){"undefined"===typeof a?this.X.td=p:this.Ta=this.Ta.concat(a)};f.prototype.o=I(function(a,b,d){"function"!==typeof d&&(d=J());if(c.e(a))q.error("No event name provided to mixpanel.track");else if(this.Db(a))d(0);
else{b=b||{};b.token=this.c("token");var e=this.persistence.Kd(a);c.e(e)||(b.$duration=parseFloat((((new Date).getTime()-e)/1E3).toFixed(3)));this.persistence.Cc(o.referrer);this.c("store_google")&&this.persistence.ee();this.c("save_referrer")&&this.persistence.xb(o.referrer);b=c.extend({},c.info.ra(),this.persistence.ra(),b);e=this.c("property_blacklist");c.isArray(e)?c.a(e,function(a){delete b[a]}):q.error("Invalid value for property_blacklist config: "+e);var a={event:a,properties:b},e=c.truncate(a,
255),g=c.ea(e),g=c.fb(g);q.log("MIXPANEL REQUEST:");q.log(e);this.i(this.c("api_host")+"/track/",{data:g},this.ja(d,e));this.Nc(a);return e}});f.prototype.Td=I(function(a,b,d){c.isArray(b)||(b=[b]);var e={};e[a]=b;this.v(e);return this.people.set(a,b,d)});f.prototype.md=I(function(a,b,d){var c=this.F(a);if(c===l){var g={};g[a]=[b];this.v(g)}else-1===c.indexOf(b)&&(c.push(b),this.v(g));return this.people.ta(a,b,d)});f.prototype.Ld=I(function(a,b,d){var c=this.F(a);if(c!==l){var g=c.indexOf(b);-1<g&&
(c.splice(g,1),this.v({pe:c}));0===c.length&&this.ua(a)}return this.people.remove(a,b,d)});f.prototype.de=I(function(a,b,d,e){var g=c.extend({},b||{});c.a(d,function(a,b){a!==w&&a!==l&&(g[b]=a)});return this.o(a,g,e)});f.prototype.Oc=function(a,b){return a+"_"+JSON.stringify(b)};f.prototype.Bd=function(a,b){var d=this.Oc(a,b),c=this.zb[d];if(c===l||c.Za!==a||c.Ya!==b)c=new u,c.ia(this,a,b),this.zb[d]=c;return c};f.prototype.yc=function(a){if(c.e(a))a=o.location.href;this.o("mp_page_view",c.info.Id(a))};
f.prototype.ce=function(){return this.bb.call(this,K,arguments)};f.prototype.be=function(){return this.bb.call(this,U,arguments)};f.prototype.Yd=function(a){c.e(a)?q.error("No event name provided to mixpanel.time_event"):this.Db(a)||this.persistence.Sd(a)};f.prototype.v=function(a,b){this.persistence.v(a,b)};f.prototype.G=function(a,b,d){this.persistence.G(a,b,d)};f.prototype.ua=function(a){this.persistence.ua(a)};f.prototype.Jb=function(a,b){var d={};d[a]=b;this.v(d)};f.prototype.nb=function(a,b,
d,c,g,f,h,i){var n=this.S();this.v({$user_id:a});this.F("$device_id")||this.G({$had_persisted_distinct_id:p,$device_id:n},"");a!==n&&a!==this.F("__alias")&&(this.ua("__alias"),this.v({distinct_id:a}));this.Ab(this.S());this.X.ob=p;this.people.Tc(b,d,c,g,f,h,i);a!==n&&this.o("$identify",{distinct_id:a,$anon_distinct_id:n})};f.prototype.reset=function(){this.persistence.clear();this.X.ob=D;var a=c.yb();this.G({distinct_id:a,$device_id:a},"")};f.prototype.S=function(){return this.F("distinct_id")};f.prototype.nd=
function(a,b){if(a===this.F("$people_distinct_id"))return q.Z("Attempting to create alias for existing People user - aborting."),-2;var d=this;c.e(b)&&(b=this.S());if(a!==b)return this.Jb("__alias",a),this.o("$create_alias",{alias:a,distinct_id:b},function(){d.nb(a)});q.error("alias matches current distinct_id - skipping api call.");this.nb(a);return-1};f.prototype.Gd=function(a){this.Jb("mp_name_tag",a)};f.prototype.sc=function(a){if(c.g(a))c.extend(this.config,a),this.c("persistence_name")||(this.config.persistence_name=
this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.Bc(this.config),G=G||this.c("debug")};f.prototype.c=function(a){return this.config[a]};f.prototype.F=function(a){return this.persistence.props[a]};f.prototype.toString=function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};f.prototype.Db=function(a){return c.ec(z)||this.X.td||c.bc(this.Ta,a)};f.prototype.Nc=I(function(a){for(var b=
this._triggered_notifs,d=0;d<b.length;d++)if((new h(b[d],this)).dd(a)){this.ab(b[d]);break}});f.prototype.Ab=I(function(a){a&&!this.X.ob&&!this.c("disable_notifications")&&(q.log("MIXPANEL NOTIFICATION CHECK"),this.i(this.c("api_host")+"/decide/",{verbose:p,version:"3",lib:"web",token:this.c("token"),distinct_id:a},this.ja(c.bind(function(a){if(a.notifications&&0<a.notifications.length){this._triggered_notifs=[];var d=[];c.a(a.notifications,function(a){(a.display_triggers&&0<a.display_triggers.length?
this._triggered_notifs:d).push(a)},this);0<d.length&&this.ab.call(this,d[0])}},this))))});f.prototype.ab=function(a){(new h(a,this)).show()};f.prototype.Uc=function(){"localStorage"===this.c("opt_out_tracking_persistence_type")&&c.localStorage.rb()&&(!this.Ha()&&this.Ha({persistence_type:"cookie"})&&this.kc({enable_persistence:D}),!this.na()&&this.na({persistence_type:"cookie"})&&this.tb({clear_persistence:D}),this.Tb({persistence_type:"cookie",enable_persistence:D}));if(this.na())this.Aa({clear_persistence:p});
else if(!this.Ha()&&(this.c("opt_out_tracking_by_default")||c.cookie.get("mp_optout")))c.cookie.remove("mp_optout"),this.tb({clear_persistence:this.c("opt_out_persistence_by_default")})};f.prototype.Aa=function(a){if(a&&a.clear_persistence)a=p;else if(a&&a.enable_persistence)a=D;else return;!this.c("disable_persistence")&&this.persistence.disabled!==a&&this.persistence.tc(a)};f.prototype.ha=function(a,b){b=c.extend({track:c.bind(this.o,this),persistence_type:this.c("opt_out_tracking_persistence_type"),
cookie_prefix:this.c("opt_out_tracking_cookie_prefix"),cookie_expiration:this.c("cookie_expiration"),cross_subdomain_cookie:this.c("cross_subdomain_cookie"),secure_cookie:this.c("secure_cookie")},b);c.localStorage.rb()||(b.persistence_type="cookie");return a(this.c("token"),{o:b.track,Zd:b.track_event_name,$d:b.track_properties,nc:b.persistence_type,mc:b.cookie_prefix,Ub:b.cookie_expiration,Vb:b.cross_subdomain_cookie,Qd:b.secure_cookie})};f.prototype.kc=function(a){a=c.extend({enable_persistence:p},
a);this.ha(Ba,a);this.Aa(a)};f.prototype.tb=function(a){a=c.extend({clear_persistence:p,delete_user:p},a);a.delete_user&&this.people&&this.people.$a()&&(this.people.Xb(),this.people.Sb());this.ha(Ca,a);this.Aa(a)};f.prototype.Ha=function(a){return this.ha(Da,a)};f.prototype.na=function(a){return this.ha(ma,a)};f.prototype.Tb=function(a){a=c.extend({enable_persistence:p},a);this.ha(Fa,a);this.Aa(a)};n.prototype.ia=function(a){this.d=a};n.prototype.set=H(function(a,b,d){var e=this.rc(a,b);c.g(a)&&(d=
b);this.M("save_referrer")&&this.d.persistence.xb(o.referrer);e.$set=c.extend({},c.info.Jd(),this.d.persistence.Cd(),e.$set);return this.i(e,d)});n.prototype.Ka=H(function(a,b,d){var e=this.uc(a,b);c.g(a)&&(d=b);return this.i(e,d)});n.prototype.Oa=H(function(a,b){return this.i(this.Ac(a),b)});n.prototype.cc=H(function(a,b,d){var e={},g={};c.g(a)?(c.a(a,function(a,b){this.N(b)||(isNaN(parseFloat(a))?q.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):g[b]=a)},
this),d=b):(c.e(b)&&(b=1),g[a]=b);e.$add=g;return this.i(e,d)});n.prototype.append=H(function(a,b,d){c.g(a)&&(d=b);return this.i(this.od(a,b),d)});n.prototype.remove=H(function(a,b,d){c.g(a)&&(d=b);return this.i(this.pc(a,b),d)});n.prototype.ta=H(function(a,b,d){c.g(a)&&(d=b);return this.i(this.zc(a,b),d)});n.prototype.ae=H(function(a,b,d){if(!c.fc(a)&&(a=parseFloat(a),isNaN(a))){q.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",
c.extend({$amount:a},b),d)});n.prototype.Sb=function(a){return this.set("$transactions",[],a)};n.prototype.Xb=function(){if(this.$a())return this.i({$delete:this.d.S()});q.error("mixpanel.people.delete_user() requires you to call identify() first")};n.prototype.toString=function(){return this.d.toString()+".people"};n.prototype.i=function(a,b){a.$token=this.M("token");a.$distinct_id=this.d.S();var d=this.d.F("$device_id"),e=this.d.F("$user_id"),g=this.d.F("$had_persisted_distinct_id");d&&(a.$device_id=
d);e&&(a.$user_id=e);g&&(a.$had_persisted_distinct_id=g);e=c.jb(a);d=c.truncate(e,255);e=c.ea(e);e=c.fb(e);if(!this.$a())return this.Qc(a),c.e(b)||(this.M("verbose")?b({status:-1,error:w}):b(-1)),d;q.log("MIXPANEL PEOPLE REQUEST:");q.log(d);this.d.i(this.M("api_host")+"/engage/",{data:e},this.d.ja(b,d));return d};n.prototype.M=function(a){return this.d.c(a)};n.prototype.$a=function(){return this.d.X.ob===p};n.prototype.Qc=function(a){"$set"in a?this.d.persistence.C("$set",a):"$set_once"in a?this.d.persistence.C("$set_once",
a):"$unset"in a?this.d.persistence.C("$unset",a):"$add"in a?this.d.persistence.C("$add",a):"$append"in a?this.d.persistence.C("$append",a):"$remove"in a?this.d.persistence.C("$remove",a):"$union"in a?this.d.persistence.C("$union",a):q.error("Invalid call to _enqueue():",a)};n.prototype.ga=function(a,b,d,e){var g=this,f=c.extend({},this.d.persistence.Ba(a)),h=f;!c.e(f)&&c.g(f)&&!c.T(f)&&(g.d.persistence.H(a,f),e&&(h=e(f)),b.call(g,h,function(b,e){0===b&&g.d.persistence.C(a,f);c.e(d)||d(b,e)}))};n.prototype.Tc=
function(a,b,d,e,g,f,h){var i=this,n=this.d.persistence.Ba("$append"),o=this.d.persistence.Ba("$remove");this.ga("$set",this.set,a);this.ga("$set_once",this.Ka,e);this.ga("$unset",this.Oa,f,function(a){return c.keys(a)});this.ga("$add",this.cc,b);this.ga("$union",this.ta,g);if(!c.e(n)&&c.isArray(n)&&n.length){for(var r,a=function(a,b){0===a&&i.d.persistence.C("$append",r);c.e(d)||d(a,b)},b=n.length-1;0<=b;b--)r=n.pop(),c.T(r)||i.append(r,a);i.d.persistence.save()}if(!c.e(o)&&c.isArray(o)&&o.length){for(var q,
n=function(a,b){0===a&&i.d.persistence.C("$remove",q);c.e(h)||h(a,b)},a=o.length-1;0<=a;a--)q=o.pop(),c.T(q)||i.remove(q,n);i.d.persistence.save()}};n.prototype.N=function(a){return"$distinct_id"===a||"$token"===a||"$device_id"===a||"$user_id"===a||"$had_persisted_distinct_id"===a};f.Kc=function(a,b){c.Ob(this);this.ba=b;this.vb=this.ba.persistence;this.Ja=this.ba.c("inapp_protocol");this.Ea=this.ba.c("cdn");this.I=c.R(a.id);this.hc=c.R(a.message_id);this.body=(c.R(a.body)||"").replace(/\n/g,"<br/>");
this.sd=c.R(a.cta)||"Close";this.pa=c.R(a.type)||"takeover";this.style=c.R(a.style)||"light";this.title=c.R(a.title)||"";this.va=h.Jc;this.da=h.Ic;this.Zb=a.display_triggers||[];this.$=a.cta_url||w;this.pb=a.image_url||w;this.z=a.thumb_image_url||w;this.Pa=a.video_url||w;if(this.z&&0===this.z.indexOf("//"))this.z=this.z.replace("//",this.Ja);this.Fa=p;if(!this.$)this.$="#dismiss",this.Fa=D;this.u="mini"===this.pa;if(!this.u)this.pa="takeover";this.Hd=!this.u?h.fa:h.Qa;this.Lb();this.Ia=this.Yc();
this.ad()};h=f.Kc;h.U=200;h.A="mixpanel-notification";h.wa=0.6;h.L=25;h.ya=200;h.fa=388;h.Qa=420;h.B=85;h.Ra=5;h.P=60;h.Sa=Math.round(h.P/2);h.Jc=595;h.Ic=334;h.prototype.show=function(){var a=this;this.Lb();this.q?(this.$c(),this.Zc(),this.fd(this.Mc)):setTimeout(function(){a.show()},300)};h.prototype.ib=c.m(function(){this.gc||this.Ib({invisible:p});var a=this.Vd?this.k("video"):this.Y();if(this.Dc)this.hd("bg","visible"),this.V(a,"exiting"),setTimeout(this.Kb,h.U);else{var b,d,c;this.u?(b="right",
d=20,c=-100):(b="top",d=h.L,c=h.ya+h.L);this.za([{s:this.k("bg"),p:"opacity",start:h.wa,l:0},{s:a,p:"opacity",start:1,l:0},{s:a,p:b,start:d,l:c}],h.U,this.Kb)}});h.prototype.V=c.m(function(a,b){b=h.A+"-"+b;"string"===typeof a&&(a=this.k(a));a.className?~(" "+a.className+" ").indexOf(" "+b+" ")||(a.className+=" "+b):a.className=b});h.prototype.hd=c.m(function(a,b){b=h.A+"-"+b;"string"===typeof a&&(a=this.k(a));if(a.className)a.className=(" "+a.className+" ").replace(" "+b+" ","").replace(/^[\s\xA0]+/,
"").replace(/[\s\xA0]+$/,"")});h.prototype.za=c.m(function(a,b,d,c){var g=this,f=D,h,i;h=1*new Date;var n,c=c||h;n=h-c;for(h=0;h<a.length;h++){i=a[h];if("undefined"===typeof i.K)i.K=i.start;if(i.K!==i.l){var f=p,o=i.l>=i.start?1:-1;i.K=i.start+(i.l-i.start)*n/b;if("opacity"!==i.p)i.K=Math.round(i.K);if(0<o&&i.K>=i.l||0>o&&i.K<=i.l)i.K=i.l}}if(f){for(h=0;h<a.length;h++)i=a[h],i.s&&(i.s.style[i.p]=""+i.K+("opacity"===i.p?"":"px"));setTimeout(function(){g.za(a,b,d,c)},10)}else d&&d()});h.prototype.Mc=
c.m(function(){var a=this;if(!this.Wd&&!this.Fb()[this.I])this.Wd=p,this.q.appendChild(this.qa),setTimeout(function(){var b=a.Y();if(a.Dc)a.u||a.V("bg","visible"),a.V(b,"visible"),a.Hb();else{var d,c,g;a.u?(d="right",c=-100,g=20):(d="top",c=h.ya+h.L,g=h.L);a.za([{s:a.k("bg"),p:"opacity",start:0,l:h.wa},{s:b,p:"opacity",start:0,l:1},{s:b,p:d,start:c,l:g}],h.U,a.Hb)}},100),c.J(a.k("cancel"),"click",function(b){b.preventDefault();a.ib()}),c.J(a.k("button")||a.k("mini-content"),"click",function(b){b.preventDefault();
a.ca?(a.cb("$campaign_open",{$resource_type:"video"}),a.jd()):(a.ib(),a.Fa&&(b=w,a.ba.c("inapp_link_new_window")?t.open(a.$):b=function(){t.location.href=a.$},a.cb("$campaign_open",{$resource_type:"link"},b)))})});h.prototype.k=function(a){return o.getElementById(h.A+"-"+a)};h.prototype.Y=function(){return this.k(this.pa)};h.prototype.Fb=function(){return this.vb.props.__cmpns||(this.vb.props.__cmpns={})};h.prototype.dd=c.m(function(a){for(var b=a.event||"",d=0;d<this.Zb.length;d++){var e=this.Zb[d];
if("$any_event"===(e.event||"")||b===e.event)if(e.selector&&!c.T(e.selector)){if(x(e.selector,a.properties))return p}else return p}return D});h.prototype.W=function(a,b){return this.D[a]&&this.D[a]<=b};h.prototype.Yc=function(){var a=[];this.u?(this.z=this.z||this.Ea+"/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.z)):(this.pb?(a.push(this.pb),this.ac='<img id="img" src="'+this.pb+'"/>'):this.ac="",this.z?(a.push(this.z),this.wc='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+
...
this.Fa||this.ca?"":'<div id="button-close"></div>',c=this.ca?'<div id="button-play"></div>':"";this.W("ie",7)&&(c=a="");a='<div id="takeover">'+this.wc+'<div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="content">'+this.ac+'<div id="title">'+this.title+'</div><div id="body">'+this.body+'</div><div id="tagline"><a href="http://mixpanel.com?from=inapp" target="_blank">POWERED BY MIXPANEL</a></div></div><div id="button">'+a+'<a id="button-link" href="'+this.$+'">'+this.sd+
"</a>"+c+"</div></div></div>"}this.Fc?(b=this.Ja+"www.youtube.com/embed/"+this.Fc+"?wmode=transparent&showinfo=0&modestbranding=0&rel=0&autoplay=1&loop=0&vq=hd1080",this.Gc&&(b+="&enablejsapi=1&html5=1&controls=0",d='<div id="video-controls"><div id="video-progress" class="video-progress-el"><div id="video-progress-total" class="video-progress-el"></div><div id="video-elapsed" class="video-progress-el"></div></div><div id="video-time" class="video-progress-el"></div></div>')):this.Ec&&(b=this.Ja+
"player.vimeo.com/video/"+this.Ec+"?autoplay=1&title=0&byline=0&portrait=0");if(this.ca)this.je='<iframe id="'+h.A+'-video-frame" width="'+this.va+'" height="'+this.da+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',d='<div id="video-'+(this.mb?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+d+"</div></div>";b=d+a;this.mb&&(b=(this.u?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.u?d:b)+"</div></div>");
this.qa.innerHTML=('<div id="overlay" class="'+this.pa+'"><div id="campaignid-'+this.I+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+h.A+"-").replace(/id=\"/g,'id="'+h.A+"-")};h.prototype.$c=function(){this.j="dark"===this.style?{gb:"#1d1f25",ka:"#282b32",Da:"#3a4147",Nb:"#4a5157",pd:"#32353c",Rb:"0.4",sb:"#2a3137",Na:"#fff",wb:"#9498a3",vc:"#464851",Ma:"#ddd"}:{gb:"#fff",ka:"#e7eaee",Da:"#eceff3",Nb:"#f5f5f5",pd:"#e4ecf2",Rb:"1.0",sb:"#fafafa",
Na:"#5c6578",wb:"#8b949b",vc:"#ced9e6",Ma:"#7c8598"};var a="0px 0px 35px 0px rgba(45, 49, 56, 0.7)",b=a,d=a,e=h.P+2*h.Ra,g=h.U/1E3+"s";this.u&&(a="none");var f={};f["@media only screen and (max-width: "+(h.Qa+20-1)+"px)"]={"#overlay":{display:"none"}};a={".flipped":{transform:"rotateY(180deg)"},"#overlay":{position:"fixed",top:"0",left:"0",width:"100%",height:"100%",overflow:"auto","text-align":"center","z-index":"10000","font-family":'"Helvetica", "Arial", sans-serif',"-webkit-font-smoothing":"antialiased",
...
h.prototype.jd=c.m(function(){function a(){t.YT&&t.YT.loaded&&b.Mb();b.Vd=p;b.Y().style.visibility="hidden"}var b=this,c=[{s:b.Y(),p:"opacity",start:1,l:0},{s:b.Y(),p:"top",start:h.L,l:-500},{s:b.k("video-noflip"),p:"opacity",start:0,l:1},{s:b.k("video-noflip"),p:"top",start:2*-b.da,l:0}];if(b.u){var e=b.k("bg"),g=b.k("overlay");e.style.width="100%";e.style.height="100%";g.style.width="100%";b.V(b.Y(),"exiting");b.V(e,"visible");c.push({s:b.k("bg"),p:"opacity",start:0,l:h.wa})}b.k("video-holder").innerHTML=
...
f.prototype.track=f.prototype.o;f.prototype.track_links=f.prototype.ce;f.prototype.track_forms=f.prototype.be;f.prototype.track_pageview=f.prototype.yc;f.prototype.register=f.prototype.v;f.prototype.register_once=f.prototype.G;f.prototype.unregister=f.prototype.ua;f.prototype.identify=f.prototype.nb;f.prototype.alias=f.prototype.nd;f.prototype.name_tag=f.prototype.Gd;f.prototype.set_config=f.prototype.sc;f.prototype.get_config=f.prototype.c;f.prototype.get_property=f.prototype.F;f.prototype.get_distinct_id=
...
f.prototype.remove_group=f.prototype.Ld;f.prototype.track_with_groups=f.prototype.de;s.prototype.properties=s.prototype.ra;s.prototype.update_search_keyword=s.prototype.Cc;s.prototype.update_referrer_info=s.prototype.xb;s.prototype.get_cross_subdomain=s.prototype.Ad;s.prototype.clear=s.prototype.clear;n.prototype.set=n.prototype.set;n.prototype.set_once=n.prototype.Ka;n.prototype.unset=n.prototype.Oa;n.prototype.increment=n.prototype.cc;n.prototype.append=n.prototype.append;n.prototype.remove=n.prototype.remove;
